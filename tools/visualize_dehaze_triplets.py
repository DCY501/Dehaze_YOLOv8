...
from ultralytics.nn.modules import DehazeHead
...
def main():
    ...
    if not any(isinstance(m, DehazeHead) for m in model.modules()):
        raise RuntimeError(f'{args.weights} does not contain DehazeHead.')
